...
include 'header.php';
$sid = $_SESSION['id'];
$msgs = "SELECT * FROM msg WHERE absender='$sid'";
$result = mysqli_query($db,$msgs);

?>
<html>
    <body>
        <p align="center"><b>Postausgang - Nachrichtenübersicht</b></p><hr><br>
        <p align="center"><?php 	while($row = $result->fetch_assoc()) {
    echo "<p align='center'>".$row['nachricht']." | Empfänger: ".$row['empfanger']."</p><br>";
} ?></p>
